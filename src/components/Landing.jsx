...
export default function Landing() {
  ...
  <span className="text-yellow-600">  Fueling Passion. Shaping Legends.
</span>
</h2>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white shadow-lg rounded-lg my-8">
        <h2 className="text-2xl font-bold mb-4 text-amber-600">What You Can Do with CricFolio</h2>
      ...
      {/* CricFolio Functionality Section */}
      <section className="bg-gray-50 py-10 px-6 md:px-20">
        <h2 className="text-3xl font-bold text-amber-600 text-center mb-6">What Can You Do with CricFolio?</h2>
